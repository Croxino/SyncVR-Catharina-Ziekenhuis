...
namespace UnityEngine.EventSystems
{
    ...
    /// </summary>
    public class SyncVRInputModule : PointerInputModule
    {
        [Tooltip("Object which points with Z axis. E.g. CentreEyeAnchor from OVRCameraRig")]
        public Transform rayTransform;

        public SyncVRCursor m_Cursor;

        [Tooltip("Gamepad button to act as gaze click")]
#if OCULUS
        public OVRInput.Button joyPadClickButton = OVRInput.Button.One;
#else
        public Pvr_UnitySDKAPI.Pvr_KeyCode joyPadClickButton = Pvr_UnitySDKAPI.Pvr_KeyCode.TRIGGER;
        ...
        [NonSerialized]
        public SyncVRRaycaster activeGraphicRaycaster;
        [Header("Dragging")]
...
#region StandaloneInputModule code
        ...
        private void ProcessMousePress(MouseButtonEventData data)
        {
            ...
            if (data.PressedThisFrame())
            {
                ...
                {
                    pointerEvent.SyncVRSetSwipeStart(Input.mousePosition);
                }
...
#region PointerEventData pool
        ...
        protected Dictionary<int, SyncVRPointerEventData> m_VRRayPointerData = new Dictionary<int, SyncVRPointerEventData>();
        ...
        virtual protected MouseState GetGazePointerData()
        {
            ...
            SyncVRPointerEventData leftData;
            ...
            SyncVRRaycaster ovrRaycaster = raycast.module as SyncVRRaycaster;
            ...
            SyncVRPhysicsRaycaster physicsRaycaster = raycast.module as SyncVRPhysicsRaycaster;
            if (physicsRaycaster)
            {
            ...
            SyncVRPointerEventData rightData;
            GetPointerData(kMouseRightId, out rightData, true);
            CopyFromTo(leftData, rightData);
            rightData.button = PointerEventData.InputButton.Right;

            SyncVRPointerEventData middleData;
...
#else
            //TODO: select active hand
            var pressed = Pvr_UnitySDKAPI.Controller.UPvr_GetKeyDown(activeControllerIndex, joyPadClickButton);
            var released = Pvr_UnitySDKAPI.Controller.UPvr_GetKeyUp(activeControllerIndex, joyPadClickButton);
#endif
...
#else
                Vector2 s = Pvr_UnitySDKAPI.Controller.UPvr_GetTouchPadPosition(1);
#endif
