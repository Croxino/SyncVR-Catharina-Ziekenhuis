...
public class SyncVRGrabbable : MonoBehaviour
{
    [SerializeField]
    ...
    protected SyncVRGrabber m_grabbedBy = null;
    ...
    /// </summary>
    public SyncVRGrabber grabbedBy
    {
    ...
    /// </summary>
    virtual public void GrabBegin(SyncVRGrabber hand, Collider grabPoint)
    {
        m_grabbedBy = hand;
